    ...
    init() {
        preload()
            .then(() => {
                ...
                levelOne.ducks.forEach((kCord) => {
                    gameObj.entities.ducks.push(new Duck(spriteSheetImage, kCord[0], kCord[1], kCord[2], kCord[3]));
                })
