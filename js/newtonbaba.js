let newtonbaba = {
    ...
    entityMarioCol(gameObj) {
        let { goombas, mario, ducks, bricks, blocks } = gameObj.entities;
    ...
    handleCollision(mario, entity, gameObj) {
        if (entity.type == "goomba" || entity.type == "duck") {
            // left
            ...
            if (mario.posY < entity.posY && (mario.posX < entity.posX + entity.width && (mario.posX + mario.width > entity.posX))) {
                if (mario.pointer != "dead" && entity.type == "duck") {
    ...
    enemyDeath(gameObj, entity, mario) {
        ...
        setTimeout(() => {
            if (entity.type == "goomba") {
                ...
                let idx = gameObj.entities.ducks.indexOf(entity);
                delete gameObj.entities.ducks[idx];
            }
    ...
    bgEntityCollision(gameObj) {
        ...
        let ducks = gameObj.entities.ducks;
